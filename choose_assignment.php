...
<div class="container">
    ...
    <div class="assignment-container">
        ...
        <div class="assignment-options">
            <a class="assignment-option individual" href="assignment_details.php?assignteacher_id=<?php echo $assignteacherID; ?>&AAselect_id=0">Individual Assignment</a>
            <a class="assignment-option group" href="assignment_details.php?assignteacher_id=<?php echo $assignteacherID; ?>&AAselect_id=1">Group Assignment</a>
        </div>
    </div> 
