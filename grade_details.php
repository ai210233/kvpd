                ...
                <table>
                    ...
                    <?php if (count($learningMaterials) > 0): ?>
                            <?php foreach ($learningMaterials as $index => $material): ?>
                                <tr style="cursor: pointer;"  onclick="window.location='grade_folder_details.php?folder_id=<?php echo $material['AAfolderID']; ?>&assignteacher_id=<?php echo $assignteacherID; ?>&AAselect_id=<?php echo $AAselect_id; ?>';">
                    ...
                    <?php if (count($learningMaterials) > 0): ?>
                            <?php foreach ($learningMaterials as $index => $material): ?>
                                <?php
                                    ...
                                    $detailsPage = $material['AssessmentType'] == 0 ? 'grade_folder_details.php' : 'grade_folder_details.php';
                                ?>
                                <tr style="cursor: pointer;"  onclick="window.location='<?php echo $detailsPage; ?>?folder_id=<?php echo $material['AssessmentfolderID']; ?>&assignteacher_id=<?php echo $assignteacherID; ?>&AAselect_id=<?php echo $AAselect_id; ?>';">
                                    <td><?php echo $index + 1; ?></td>
                                    <td><?php echo htmlspecialchars($material['FolderName']); ?></td>
