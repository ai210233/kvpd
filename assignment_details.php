...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['selectedRows'])) {
    ...
    $deleteQuery = "DELETE FROM aafolder WHERE AAfolderID IN ($placeholders)";
    ...
    <div class="assignment-folder-container">
        ...
        <form method="POST" id="deleteForm">
            ...
            <div class="action-buttons">
                <button type="button" onclick="window.location='add_folder_assignment.php?assignteacher_id=<?php echo $assignteacherID; ?>&AAselect_id=<?php echo $AAselect_id; ?>';">Add Assignment</button>
                    ...
                    <?php if (count($learningMaterials) > 0): ?>
                            <?php foreach ($learningMaterials as $index => $material): ?>
                                <tr style="cursor: pointer;">
                                    ...
                                    <td>
                                        <input type="checkbox" name="selectedRows[]" value="<?php echo htmlspecialchars($material['AAfolderID']); ?>" onclick="toggleDeleteButton()">
                                    </td>
                                    <td onclick="window.location='assignment_material_details.php?folder_id=<?php echo $material['AAfolderID']; ?>&assignteacher_id=<?php echo $assignteacherID; ?>';"><?php echo $index + 1; ?></td>
                                    <td onclick="window.location='assignment_material_details.php?folder_id=<?php echo $material['AAfolderID']; ?>&assignteacher_id=<?php echo $assignteacherID; ?>';"><?php echo htmlspecialchars($material['FolderName']); ?></td>
                                    <td onclick="window.location='assignment_material_details.php?folder_id=<?php echo $material['AAfolderID']; ?>&assignteacher_id=<?php echo $assignteacherID; ?>';"><?php echo htmlspecialchars($material['DueDate']); ?></td>
                                    <td onclick="window.location='assignment_material_details.php?folder_id=<?php echo $material['AAfolderID']; ?>&assignteacher_id=<?php echo $assignteacherID; ?>';"><?php echo htmlspecialchars($material['FolderDate']); ?></td>
                                    <td onclick="window.location='assignment_material_details.php?folder_id=<?php echo $material['AAfolderID']; ?>&assignteacher_id=<?php echo $assignteacherID; ?>';"><?php echo htmlspecialchars($material['ShowFolder'] == 0) ? 'Unlocked' : 'Locked'; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
                                <td colspan="6">No assignment added yet.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
