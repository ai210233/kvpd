...
<div class="container">
    ...
    <div class="assessment-container">
        ...
        <div class="assessment-options">
            <a class="assessment-option quiz" href="assessment_student_details.php?assignteacher_id=<?php echo $assignteacher_id; ?>&AAselect_id=2">Quiz</a>
            <a class="assessment-option test" href="assessment_student_details.php?assignteacher_id=<?php echo $assignteacher_id; ?>&AAselect_id=3">Test</a>
        </div>
    </div>  
